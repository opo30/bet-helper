                        ...
                        var updateMsg = function () {
                            Ext.Ajax.request({
                                ...
                                success: function (rep, res) {
                                    ...
                                    if (Math.abs(OddsCompareList.getSupport(v[0])) < 10 && OddsCompareList.getCount(v[0]) < 50) {
    ...
    function showdetail(n, event) {
        ...
        try {
            ...
            for (var i = 0; i < rq.length; i++) {
                ...
                if (R[1] == "1")
                    html += "<tr bgcolor=white align=center><td width=6% height=18><img src='http://bf.nowscore.com/images/" + R[2] + ".gif'></td><td width=38%>" + R[4] + "</td><td width=12% bgcolor=#EFF4EA>" + R[3] + "'</td><td width=38%></td><td width=6%></td></tr>";
                else
                    html += "<tr bgcolor=white align=center><td width=6% height=18></td><td width=38%></td><td width=12% bgcolor=#EFF4EA>" + R[3] + "'</td><td width=38%>" + R[4] + "</td><td width=6%><img src='http://bf.nowscore.com/images/" + R[2] + ".gif'></td></tr>";
            }
            html += "</table>";
