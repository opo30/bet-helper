...
var Odds1x2Manage = function (scheduleArr, scheduleTypeArr) {
    ...
    Odds1x2store.on("datachanged", function (store) {
        //        Ext.Ajax.request({
        //            url: 'data/NowGoal/GetOddsDataCount.aspx',
        //            method: 'post',
        //            params: {
        //                scheduleArr[0]: scheduleArr[0]
        //            },
        //            success: function (p1, p2) {
        //                var result = Ext.decode(p1.responseText);
        //                if (result.recordcount == 0)
        //                    datainfo.setText("无数据");
        //                else
        //                    datainfo.setText("赔率数据：" + result.recordcount + "；最后更新" + result.lasttime);
        //            },
        //            failure: function () {
        //                Ext.getCmp("btn_update").setTooltip("连接数据库失败");
        //            }
        //        });
    });
    ...
    var tab = center.getItem("Odds1x2Tab");
    if (!tab) {
        var tab = center.add({
            id: "Odds1x2Tab",
            iconCls: "totalicon",
