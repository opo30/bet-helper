...
namespace SeoWebSite.BLL
{
	...
	{
        private readonly SeoWebSite.DAL.ScheduleType dal = new SeoWebSite.DAL.ScheduleType();
		public ScheduleType()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public SeoWebSite.Model.ScheduleType GetModelByCache(int id)
		{
			...
			return (SeoWebSite.Model.ScheduleType)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<SeoWebSite.Model.ScheduleType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SeoWebSite.Model.ScheduleType> DataTableToList(DataTable dt)
		{
			List<SeoWebSite.Model.ScheduleType> modelList = new List<SeoWebSite.Model.ScheduleType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SeoWebSite.Model.ScheduleType model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new SeoWebSite.Model.ScheduleType();
