...
Ext.ux.grid.GroupSummary.Calculations = {
    ...
    'button': function(v, record, field, data) {
        if (record.data.iscomplete == "0")
            return "<div onclick='alert(\"" + record.data.lineid + "\")' style='cursor:hand;vertical-align:middle;' ><img src='Images/icons/add.png'  style='\vertical-align:middle'\/>追注</div>";
        else
            return "追注结束";
    }
};
