...
namespace SeoWebSite.DAL
{
	...
	public class ScheduleClassDAO
	{
		...
		public int GetMaxId()
		{
            return DbHelperSQL.GetMaxID("id", "ScheduleClass"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from ScheduleClass");
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("update ScheduleClass set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from ScheduleClass ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
		...
		public SeoWebSite.Model.ScheduleClass GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 id,name,data from ScheduleClass ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
		...
		public DataSet GetList(string strWhere)
		{
            ...
            strSql.Append(" FROM ScheduleClass ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "ScheduleClass";
            parameters[1].Value = "";
