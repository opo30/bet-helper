...
namespace SeoWebSite.DAL
{
    ...
    /// 数据访问类:CountryClass
    /// </summary>
    public partial class CountryClassDAO
    {
        public CountryClassDAO()
        { }
        #region  Method
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "CountryClass");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from CountryClass");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from CountryClass ");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,data ");
            strSql.Append(" FROM CountryClass ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "CountryClass";
