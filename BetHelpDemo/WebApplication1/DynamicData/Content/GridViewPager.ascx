...
<div class="DDPager">
    <span class="DDFloatLeft">
        <asp:ImageButton AlternateText="首页" ToolTip="首页" ID="ImageButtonFirst" runat="server" ImageUrl="Images/PgFirst.gif" Width="8" Height="9" CommandName="Page" CommandArgument="First" />
        &nbsp;
        ...
        &nbsp;
        <asp:Label ID="LabelPage" runat="server" Text="页数: " AssociatedControlID="TextBoxPage" />
        ...
        &nbsp;
        <asp:ImageButton AlternateText="末页" ToolTip="末页" ID="ImageButtonLast" runat="server" ImageUrl="Images/PgLast.gif" Width="8" Height="9" CommandName="Page" CommandArgument="Last" />
    </span>
